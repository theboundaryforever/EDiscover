...
public class EaseContactAdapter2 extends ArrayAdapter<UserClass2> implements SectionIndexer {
    ...
    public EaseContactAdapter2(Context context, int resource, List<UserClass2> objects) {
    ...
    public EaseContactAdapter2 setPrimaryColor(int primaryColor) {
        this.primaryColor = primaryColor;
        return this;
    }


    public EaseContactAdapter2 setPrimarySize(int primarySize) {
        this.primarySize = primarySize;
        return this;
    }

    public EaseContactAdapter2 setInitialLetterBg(Drawable initialLetterBg) {
        this.initialLetterBg = initialLetterBg;
        return this;
    }

    public EaseContactAdapter2 setInitialLetterColor(int initialLetterColor) {
