...
public class ThreadPoolManager {
    ...
    private static long KEEPALIVETIME = 5 * 1000;
    private static ThreadPoolProxy mNormalPool = new ThreadPoolProxy(POOLSIZE, MAXPOOLSIZE, KEEPALIVETIME);//param 0  最大线程数，param 1 核心线程数
    private static ThreadPoolProxy mDownloadPool = new ThreadPoolProxy(POOLSIZE, MAXPOOLSIZE, KEEPALIVETIME);
